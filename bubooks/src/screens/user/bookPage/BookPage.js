...
const BookPage = () => {
    ...
    const [bookData, setBookData] = useState({
        ...
        comments: [{
            ...
            rating: 4,
            user: 'John'
        }, {title: 'Comment 2', comment: 'orem ipsum dolor sit amet, consectetur adipiscing elit. Sed et nunc et dolor porta volutpat. Ut aliquet tristique est, vitae iaculis nisi faucibus eget. Phasellus cursus lacinia diam, a.', rating: 5, user: 'Jane'}, {
            title: 'Comment 3',
            ...
            <div className="commentSection">
                ...
                <div className="addComment">
                    ...
                    <div className="commentBox">
                        <p>Rating:</p>
                        <input className='bookPageRatingArea'
                        type="number"
                        min="1"
                        max="5"
                        value={rating}
                    ...
                    />
                        <p>Comment:</p>
                    <textarea className='bookPageTextArea'
                        value={comment}
